...
export const Utils = {
  ...
  getAccountDataRanges : function(returnNullRangesIfEmpty = false)
  {
    var acctRanges = {
      hdrRange : null,
      dateRange : null,
  ...
  // Array.findIndex() not available, so we provide it here.
  findArrayIndex(arr, callback)
  {
    if (!arr) {
      throw new TypeError('Array object must not be null or undefined');
